...
//        s32 val = _4[12] + *val2;
    ...
    f32 MapCol::fn_800BBE2C(JGeometry::TVec3f& param_1) {
        ...
        PSVECSubtract(&param_1, _4[1], &stack_d8);
        bool vecCheck4 = vecCheckto_4(stack_d8);

        if (!vecCheck4) return 32000.0f;

        for (; stack_d8.y > _4[2].y; stack_d8.y += _4[2].y) {
            bool bVar5 = false;
