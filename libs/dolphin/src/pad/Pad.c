...
static u32 Type[4]; // size: 0x10, address: 0x10
static PADStatus Origin[4]; // size: 0x30, address: 0x20
...
static void (* MakeStatus)(s32, PADStatus *, u32 *) = SPEC2_MakeStatus; // size: 0x4, address: 0xC
